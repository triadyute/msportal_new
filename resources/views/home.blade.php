                ...
                <div class="card-body">
                    <div class="row">
                                ...
                                <h2>
                                    ...
                                    <strong>
                                        <select class="form-control" id="salesSelector">
                                            <option value="Porto Admin" selected>Change Control</option>
                                            <option value="Porto Drupal" >Temporary Access</option>
                                            <option value="Porto Wordpress" >Permanent Access</option>
                                        </select>
                                    </strong>
                                </h2>
                        ...
                        <div class="col-xl-4 text-center">
                            <h2 class="card-title mt-3">Approval Rate</h2>
                            <div class="liquid-meter-wrapper liquid-meter-sm mt-3">
                                ...
                                <div class="liquid-meter-selector mt-4 pt-1" id="meterSalesSel">
                                    <a href="#" data-val="98" class="active">Monthly Approvals</a>
                                    <a href="#" data-val="95">Annual Approvals</a>
                                </div>
                            </div>
                        </div>
                    </div>
